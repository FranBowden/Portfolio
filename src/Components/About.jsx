    ...
    >
      ...
      >
        ...
        >
          ...
          <h2 className="cursor-default text-lg font-light font-mono text-center md:text-left text-accent/90">
            Software Developer <span className="text-zinc-400">•</span> Based in
            Bath, UK
            <span
